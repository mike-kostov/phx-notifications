...
> transport) is intentionally post-v1. Local folder remains `phoenix_notifications/`
> (cosmetic); package/app/modules are `phx_notifications` / `PhxNotifications.*` as decided.
